    ...
    >
      <main className="container mx-auto py-12">
        <section className="hero text-center mb-10">
          <h1 className="text-6xl font-bold text-red-800 animate-fade-in text-[6rem] font-black text-center ">
            Welcome to <span className="text-green-400 text-[6rem] font-black text-center text-stroke-green">FitLife</span>
          </h1>
